...
function renderAuthenticatedHomeHtml(html) {
  return html
    .replace(
      '<section class="hero page-panel" data-page="home">',
      '<section class="hero hero-authenticated page-panel" data-page="home">'
    )
    .replace(
    ...
    .replace(
      `Your customers ask ChatGPT and Google AI before they ever click a link.
