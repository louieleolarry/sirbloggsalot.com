...
function createBlawgyCompat({ root, readSessionUser, readRequestJson, sendJson, publicUser }) {
  ...
  function routeRootExtra(req, url, body, account, user) {
    ...
    const siteName = cleanSite(body.site || body.siteId || body.siteDomain || firstParam(url, "site") || firstParam(url, "siteId") || firstParam(url, "website") || Object.keys(account.sites)[0]);
