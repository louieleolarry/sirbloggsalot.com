...
const missingPocketsPath = path.join(root, "docs", "blawgy-missing-screenshot-pockets-2026-08-19.md");
...
[
  ...
  "docs/blawgy-missing-screenshot-pockets-2026-08-19.md",
...
assert.ok(!capture.includes("## Highest Priority Screenshot Pockets"), "Capture handoff should not keep the stale duplicate screenshot-pocket section.");

[
  "Highest-Value Screenshots To Capture Next",
  "article-builder-generated-editor.png",
  "content-plan-article-drawer.png",
  "settings-cms-provider-error.png",
  "tracking-reports-active-states.png",
  "products-inventory-sync-states.png",
  "mobile-account-long-modal.png",
  "Public case-study index/detail routes",
].forEach((needle) => {
...
[
  ...
  "tracking-reports-active-states.png",
  "products-inventory-sync-states.png",
  "image-settings-generated-output.png",
  "team-workspace-switcher-open.png",
  "mobile-account-long-modal.png",
].forEach((needle) => {
  assert.ok(engineering.includes(needle), `Engineering handoff missing current August 19 screenshot filename: ${needle}`);
});
...
[
  ...
  assert.ok(progress.includes(needle), `Progress packet missing current August 19 screenshot filename: ${needle}`);
});
